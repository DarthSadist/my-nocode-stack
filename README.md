...
- **Публичный веб-интерфейс**: Доступ к интерфейсу SearXNG не требует аутентификации для удобства использования
...
> **Примечание**: Базовая HTTP-аутентификация была отключена для упрощения доступа. При необходимости её можно включить, отредактировав Caddyfile.
